...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_restaurnatId_fkey" FOREIGN KEY ("restaurnatId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
